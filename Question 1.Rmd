...
By manually searching using the bisection method, we come to the conclusion that given the baseline optimal solution, $11200 is the lowest amount we can pay Dave whereby he is not included in any optimal solution. Therefore to include him in any optimal solution we can pay him anywhere from $10000 up to $11199.99 
